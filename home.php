            ...
            <?php 
                ...
                if ($tasks_result -> num_rows > 0) {
                    ...
                    while($task = $tasks_result -> fetch_assoc()) {
                        ...
                        echo "<div class='shadow-sm border rounded container-fluid d-flex align-items-center justify-content-between p-2 mb-4 $task_class'>";
                        echo "<h5>" . htmlspecialchars($task["title"]) . "</h6>";
